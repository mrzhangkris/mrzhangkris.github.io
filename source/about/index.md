...
.agent-card .agent-icon{font-size:26px;line-height:1;flex-shrink:0}
...
@media (max-width:680px){.agent-team-grid{grid-template-columns:repeat(2,1fr)}}
@media (max-width:420px){.agent-team-grid{grid-template-columns:1fr}}
</style>
...
<div class="agent-team-grid">
  ...
  <div class="agent-card">
    ...
    <div class="agent-role"><b>写代码</b> · 编码实现 · 插件开发 · 脚本编写 · 大批量代码翻新 · 容器实跑验证</div>
  </div>
  <div class="agent-card">
    <div class="agent-head"><div class="agent-icon">🔨</div><div class="agent-name">鲁班</div></div>
    <div class="agent-role"><b>干重活</b> · 复杂工程攻坚 · 大规模重构 · 多轮迭代 · 硬骨头任务 · 全量迁移</div>
  </div>
  <div class="agent-card">
    <div class="agent-head"><div class="agent-icon">📐</div><div class="agent-name">墨翟</div></div>
    <div class="agent-role"><b>写代码</b> · 代码生成 · 规范实现 · 工程落地 · 按规格交付 · 快速原型</div>
  </div>
  <div class="agent-card">
    <div class="agent-head"><div class="agent-icon">📖</div><div class="agent-name">白泽</div></div>
    <div class="agent-role"><b>军师</b> · 深度分析 · 资料调研 · 方案研判 · 竞品对比 · 知识梳理</div>
  </div>
  <div class="agent-card">
    <div class="agent-head"><div class="agent-icon">👂</div><div class="agent-name">谛听</div></div>
    <div class="agent-role"><b>干杂活</b> · 日常巡检 · 异常监测 · 杂项处理 · 定时值守 · 辅助支撑</div>
  </div>
</div>
